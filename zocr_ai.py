...
def capabilities() -> dict[str, Any]:
    ...
    return {
        ...
        "endpoints": {
            ...
            "GET /api/eye/authority": "Independent weapon authority — entity eyeball",
            "GET /api/eye/targets": "Known targets + threat_weapon_map",
            "GET /api/eye/teach/doctrine?lesson=authority": "Teach voice — eye instructs operator",
            "GET /api/eye/understand?threat=provenance_mismatch": "Resolve threat → weapon before strike",
